...
public class CategoryController {
    ...
    public CategoryDto getCategory(@RequestParam int id) throws Exception {
    ...
    public List<SubcategoryDto> getAllSubcategoriesInCategory(@RequestParam int id)throws CategoryNotFoundException {
